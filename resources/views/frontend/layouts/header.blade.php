...
<head>
    ...
    <!-- Timecircles -->
    <link rel="stylesheet" href="{{asset ('frontend/assets/css/timecircles.min.css')}}">
...
<body class="template-color-3">
    ...
    <div class="main-wrapper">
        ...
        <header class="header-main_area header-main_area-3">
            ...
            <div class="header-bottom_area header-bottom_area-2   white--color" style="margin-top: 40px;">
