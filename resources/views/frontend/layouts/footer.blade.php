                        ...
                        <div class="col-lg-4">
                            <div class="footer-widgets_info">
                                ...
                                <div class="widget-short_desc">
                                    <p>Where Elegance Meets Excellence – Discover Timeless Beauty at Mani Jeweller's 💎✨
                                    </p>
                                </div>
                    ...
                    <div class="footer-bottom_nav">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="payment">
                                    <a href="#">
                                        <img src="{{ asset ('frontend/assets/images/footer/payment/1.png')}}" alt="Mani Jeweller Payment Method">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="copyright">
                                    <span>Copyright &copy; 2024 <a href="https://sudhirkumar.netlify.app/">Sudhirkdnw.</a> All rights reserved.</span>
                                </div>
                            </div>
                        </div>
                    </div>
